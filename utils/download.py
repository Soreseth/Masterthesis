...
Downloads:
  1. Parameterlab Pile datasets (8 subsets) from HuggingFace
  2. Pythia target models (pythia-2.8b + pythia-6.9b final checkpoints)
  3. Pythia reference models (70m, 160m, 410m, 1b × 2 checkpoints each = 8 models)
"""
...
def download_ref_models(hf_dir: str):
    """Download all 8 reference models (4 sizes × 2 checkpoints)."""
...
def download_datasets(hf_dir: str):
    """Download all 8 parameterlab Pile datasets."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Download all datasets and models for the MIA pipeline in your hf_dir"
    )
    ...
    print(f"Models and dataset saved under huggingface directory {hf_dir}")
